...
const workItems = [
  {
    ...
    products: [
      ...
      },
      {
        name: "DriveCost",
        description:
          "給油記録から実燃費を計算し、ドライブ時のガソリン代を見積もれるシンプルなAndroidアプリです。",
        href: "/drivecost",
        image: "/drivecost.png",
            ...
            {workItems.map((item) => (
              ...
              >
                ...
                {item.products !== undefined && (
                  <div className="mt-6 space-y-5 border-zinc-200 border-t pt-5 dark:border-zinc-800">
